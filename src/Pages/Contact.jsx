    ...
    try {
      if (!contactEmail) {
        await Swal.fire({
          ...
          text: "Add VITE_CONTACT_EMAIL to enable the contact form.",
          icon: "info",
      ...
      await Swal.fire({
        ...
        text: "Your email app should open with the message prepared.",
        icon: "success",
        confirmButtonColor: "#6366f1",
      });
      ...
      Swal.fire({
        ...
        text: "The contact draft could not be created. Please try again.",
        icon: "error",
        confirmButtonColor: "#6366f1",
      });
    } finally {
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] ">
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Have a question? Send me a message and I&apos;ll get back to you as
          soon as possible.
        </p>
      </div>
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Something you&apos;d like to discuss? Send me a message and
                  let&apos;s talk.
                </p>
              </div>
